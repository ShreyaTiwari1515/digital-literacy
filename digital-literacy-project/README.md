...
- **task-2-portfolio/**  
  Screenshots of professional profiles including GitHub, LinkedIn, and Kaggle.

- **task-3-platforms/**  
  Coding challenge completion and Google Form collaboration activity.

- **task-4-email-etiquette/**  
  Professional email drafts and social media etiquette checklist.

- **task-5-cybercrime/**  
  Cybercrime case study and online safety prevention checklist.
...
- Responsible digital communication and email etiquette
...
## Submission
This repository is submitted as part of the Digital Literacy Project assessment for CSE0001.
